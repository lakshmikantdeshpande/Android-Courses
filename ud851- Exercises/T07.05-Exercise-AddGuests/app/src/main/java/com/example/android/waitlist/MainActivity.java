...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            partySize = Integer.parseInt(String.valueOf(mNewPartySizeEditText.getText()));
        } catch (NumberFormatException nfe) {
            Log.d(LOG_TAG, "Fuck, probably the db is messed up!");
        }

        // TODO (14) call addNewGuest with the guest name and party size
        addGuest(String.valueOf(mNewGuestNameEditText.getText()), partySize);
    ...
    private long addGuest(String guestName, int guestCount) {
        ...
        contentValues.put(WaitlistEntry.COLUMN_PARTY_SIZE, guestCount);
