...
public class MainActivity extends AppCompatActivity {
    ...
    private void shareText(String sharableText) {
        ...
        Intent shareIntent = ShareCompat.IntentBuilder
                ...
                .setType(mimeType)
                .setText(sharableText).getIntent();
