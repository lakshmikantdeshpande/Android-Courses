...
public class NotificationUtils {
    ...
    public static final int ACTION_IGNORE_PENDING_INTENT_ID = 444;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 333;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        NotificationCompat.Action ignoreReminderAction = new NotificationCompat.Action(R.drawable.ic_drink_notification,
                "No, Thanks",
