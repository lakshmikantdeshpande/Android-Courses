...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        String webpageURL = "http://www.google.co.in/";
    ...
    private void openWebPage(String websiteURL) {
        // TODO (2) Use Uri.parse to parse the String into a Uri
        Uri parsedUri = Uri.parse(websiteURL);
        // TODO (3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
        Intent websiteIntent = new Intent(Intent.ACTION_VIEW, parsedUri);
