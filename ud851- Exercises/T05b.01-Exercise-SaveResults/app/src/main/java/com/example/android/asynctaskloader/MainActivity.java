...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_QUERY_RESULTS = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(SEARCH_QUERY_RESULTS));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String searchURL = String.valueOf(mUrlDisplayTextView.getText());
        String searchResults = String.valueOf(mSearchResultsTextView.getText());

        outState.putString(SEARCH_QUERY_URL_EXTRA, searchURL);
